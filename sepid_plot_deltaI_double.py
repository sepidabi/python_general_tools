...
# Set labels on joint
#ax_joint.set_xlabel(r' $\mathrm{\Delta} I_\mathrm{{Ca K}}$ [%]', fontdict = font)
ax_joint.set_ylabel(r' $\mathrm{\Delta} I_{\mathrm{H}\alpha}$ [%]', fontdict = font)
...
plt.show()
filename = outdir + 'I_dif_scatter_density_modified.pdf'
...
# Set labels on joint
ax_joint.set_xlabel(r' $\mathrm{\Delta} I\mathrm{_{Ca K}}$ [%]', fontdict = font)
ax_joint.set_ylabel(r' $\mathrm{\Delta} I\mathrm{_{Ca IR}}$ [%]', fontdict = font)
ax_joint.tick_params(labelsize = fontsize)
ax_marg_x.tick_params(labelsize = fontsize)
ax_marg_y.tick_params(labelsize = fontsize)
...
plt.show()
filename = outdir + 'I_dif_scatter_density_ca8542_modified.pdf'
fig.savefig(filename, dpi = 1000)
